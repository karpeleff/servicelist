      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"  ><a href="add_note.html">New task</a></li>
...
<br>
<div class="input-group">
  <span class="input-group-addon" id="basic-addon3">GADGET:</span>
  <input type="text" class="form-control">
</div>
...
<br>	
<button type="button" class="btn btn-success">ADD TO WORK!</button>	
